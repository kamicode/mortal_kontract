...
/**
 * provider Table class
 */
class Mortal_kontractsTableprovider extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__mortal_kontracts_providers', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '') {
        ...
        if (!JFactory::getUser()->authorise('core.admin', 'com_mortal_kontracts.provider.' . $array['id'])) {
            $actions = JFactory::getACL()->getActions('com_mortal_kontracts', 'provider');
            $default_actions = JFactory::getACL()->getAssetRules('com_mortal_kontracts.provider.' . $array['id'])->getData();
            $array_jaccess = array();
    ...
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_mortal_kontracts.provider.' . (int) $this->$k;
    }
